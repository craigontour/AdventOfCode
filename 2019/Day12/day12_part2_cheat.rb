# https://github.com/J-Swift/advent-of-code-2019/blob/master/day_12/part_2/solution.rb
...
def hash_all(moons, axis)
    moons.map { |it| 
      puts "hash this moon #{it.position} #{it.velocity} on axis #{axis}"
      hash_for(it, axis) }.join('x')
end
